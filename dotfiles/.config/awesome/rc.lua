...
beautiful.init(awful.util.getdir("config") .. "/themes/trinity/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    -- We are using lxsession. When killing awesome, things go boom. Display
    -- logout handler instead.
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
    -- TODO: Patch urxvt, because flickers when ignoring size hints.
    { rule = { class = "URxvt" },
